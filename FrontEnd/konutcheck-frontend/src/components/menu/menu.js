                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="me-auto">
                                ...
                                <NavDropdown title="HESABIM" id="basic-nav-dropdown">
                                    ...
                                    {this.props.isLoggedOn && <NavDropdown.Item href="/list-passive-homes">Ev Onayla</NavDropdown.Item>}
                                    {this.props.isLoggedOn && <NavDropdown.Item href="/tenant-homes">Kiracı Olduğum Evler</NavDropdown.Item>}
                                    {this.props.isLoggedOn && <NavDropdown.Item href="/landlord-homes">Sahip Olduğum Evler</NavDropdown.Item>}
                                    {this.props.isLoggedOn && <NavDropdown.Item href="/landlord-tenants">Kiracılarım</NavDropdown.Item>}
